...
public class Modeldwarf<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bone3.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(20, 0).addBox(-4.0F, -1.0F, 3.0F, 4.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, -7.0F, 11.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r2 = bone3.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, 0.0F, 6.0F, 6.0F, 4.0F, 8.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone2 = partdefinition.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(0, 26)
						.addBox(0.0F, -17.0F, 4.0F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(23, 20)
						.addBox(0.0F, -16.0F, 4.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 16)
						.addBox(-3.0F, -12.0F, 4.0F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 23.0F, -3.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r3 = bone2
				.addOrReplaceChild("cube_r3",
						CubeListBuilder.create().texOffs(23, 20).addBox(-17.0F, -1.0F, 5.0F, 1.0F, 0.0F, 1.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = bb_main.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.0F, 0.0F, 4.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-5.0F, 0.0F, 14.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 23)
						.addBox(-5.0F, 4.0F, 11.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(20, 23)
						.addBox(-5.0F, 4.0F, 7.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = bb_main.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 12)
						.addBox(-3.0F, -6.0F, -5.0F, 6.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(22, 6)
		...
		PartDefinition cube_r7 = bb_main.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(20, 5).addBox(-2.0F, -2.0F, 0.0F, 1.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, -1.0F, 0.0F, -1.5708F, 0.0F));
